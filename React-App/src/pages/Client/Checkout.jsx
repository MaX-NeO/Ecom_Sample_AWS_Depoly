...
const Checkout = () => {
    ...
    const name = Cookies.get('xuserName')
    const phone = Cookies.get('xuserPhone')
    const email = Cookies.get('xuserEmail')
    const address = Cookies.get('xuserAddress')
    const datex = () =>{
        const date = new Date();
    ...
    const handleOrder = async()=>{
        ...
        const orderdata = {
            ...
            orderproducts : data.pData,
            ordertotal : data.pTotal,
            orderaddress : address,
            paymentmode : "cod"
        }
       const checkstatus =  await addOrder(uid,orderdata)
